...
class Notification_model extends Model {
    ...
    function __construct()
    {
        ...
        $this->rs['event_obj'] = ''; $this->rt['event_obj'] = 'BLOB'; // JSON object with last notification data
        $this->rs['cron'] = '@hourly'; // Cron expression
        $this->rs['last_run'] = 0; // Last run timestamp
        $this->rs['next_run'] = 0; // Next run timestamp
